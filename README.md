...
- OpenAI API Cookbook [[Packt]](https://www.packtpub.com/en-in/product/openai-api-cookbook-9781805121350) [[Amazon]](https://www.amazon.com/OpenAI-API-Cookbook-intelligent-applications/dp/1805121359/ref=sr_1_1?sr=8-1)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=YLjwg0Uk9LE&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=4)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=fIcphc1AmSk&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=5)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=nBl14is8Ctk&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=6)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=TnRUSfqxjOs&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=7)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=WQj4iry11y4&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=8)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=a1ptlAHSSJw&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=9)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=s64agsBili4&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=10)

- `chapter_10/01_solve_mountain_car.py`: Solve the Gymnasium _MountainCar_ environment (then run `mountain_car.py` to view the solution).
- `chapter_10/02_solve_cart_pole.py`: Solve the Gymnasium _CartPole_ environment (then run `cart_pole.py` to view the solution).
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=rcSN8HyUNfs&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=11)

- `chapter_11/01_find_mystery_word.py`: Play a _Semantle_-like Mystery-Word game, and find the mystery word.
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=pNRHs8JmUZo&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=12)

- `chapter_12/01_counterfactual_search.py`: Apply a _counterfactual_ analysis to the _German Credit Risk_ dataset and discover valuable insights.
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=iLAyznPb6gc&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=13)
...
[Hands-On Video Tutorial](https://www.youtube.com/watch?v=nl_UKnlZEtk&list=PLT2RSfUt4goqwml-im6HvVrOZ6MH2RZOj&index=14)
...
- `chapter_16/01_gp_even_parity.py`: Solve the _even parity_ problem using **genetic programming**.
- `chapter_16/02_gp_even_parity_reduced.py`: Simplify the _even parity_ solution by adding a constraint.
- `chapter_16/03_neat_even_parity.py`: Solve the _even parity_ problem using **NeuroEvolution of Augmenting Topologies (NEAT)**.
